...
#
# print("Mean of sample :- ", std_deviation)
...
#pass the number of data points your want as counter
...
def show_fig(mean_list):
    ...
    fig.add_tance(go.Scatter(x=[mean, mean], y=[0, 1], mode="lines, name="MEAN))
    fig.show()
...
# code to find standard deviation of the sample data
def standard_deviation():
    ...
    print("Standard deviation of sampling distribution:_", std_deviation)
